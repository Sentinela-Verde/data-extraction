"""Fluxo PARALELO de teste com imagem menor (300m x 300m) -- ver docstring de
extract/imagens_satelite/landsat/extraction_landsat_300m.py pro porque. Mesma logica de
step_classificacao_obra.py, so trocando config_obra por config_obra_300m (saidas em
pastas com sufixo _300m, nao encosta em nada do fluxo de 500m).
