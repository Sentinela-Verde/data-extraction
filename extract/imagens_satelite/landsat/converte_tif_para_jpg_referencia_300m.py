"""Mesma coisa que `converte_tif_para_jpg_referencia.py`, mas pra pasta do teste de imagem
menor (`extraction_landsat_300m.py`) — fluxo separado, não mexe nos JPGs de 500m.

Como rodar:
    python extract/imagens_satelite/landsat/converte_tif_para_jpg_referencia_300m.py
"""
import os
...
TIF_DIR = ROOT_DIR / 'data/raw/imagens_satelite_landsat_300m'
